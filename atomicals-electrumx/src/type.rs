...
"#,
        ...
        if let Some(bitworkc) = &self.mint_bitworkc {
            writeln!(f, "    Mint bitworkC: {}", bitworkc)?;
        }
...
pub struct DftInfo {
    pub mint_count: u64,
    // "mint_bitworkc_current": "888888888.3",
    // "mint_bitworkc_next": "888888888.4",
    // "mint_bitworkc_next_next": "888888888.5"
